...
# Initialiser votre application Dash
app = init_dashboard()

# Ajouter Talisman pour forcer HTTPS
Talisman(app)

if __name__ == '__main__':
    context = ssl.SSLContext(ssl.PROTOCOL_TLS_SERVER)
    context.load_cert_chain(certfile='key.pem', keyfile='cert.pem')

    app.run(host='0.0.0.0', port=8050, ssl_context=context)
